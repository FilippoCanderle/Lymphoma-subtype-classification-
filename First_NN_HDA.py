...
def Compile_Train_cnn(cnn,X_train, Y_train,X_test, Y_test):
    batch_size=64 
    nb_epochs=8 
...
def Model_history(My_keras_model):
...
def Model_save(cnn):
    cnn.save("Lymphoma_CNN_Classifier.h5")
    
def Load_Model():
    from keras.models import load_model
    new_model = load_model("Lymphoma_CNN_Classifier.h5")
...
def Image_prediction(path="tests_predictions/mcl_prova.tif"):
